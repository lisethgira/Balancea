        ...
        <div className={styles.graphic__section}>
            ...
            <div className={styles.graphic}>
                ...
                margin={{ top: 30, right: 40, left: 10, bottom: 10 }}>
                    ...
                    <Area type="monotone" dataKey="Incoming" stroke="#00D6BD" fillOpacity={0.5} fill="url(#colorPv)" />
                    <Area type="monotone" dataKey="Expense" stroke="#ff7a95" fillOpacity={0.6} fill="url(#colorUv)" />
                </AreaChart>
                </ResponsiveContainer>
            </div>
